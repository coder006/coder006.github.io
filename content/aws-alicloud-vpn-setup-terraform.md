...
The link to the entire code can be found at the [tf-aws-alicloud-vpn](https://github.com/coder006/tf-aws-alicloud-vpn.git "Github Repository") repository on Github.
